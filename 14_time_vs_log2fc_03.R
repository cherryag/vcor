...
save_dir='/Users/Cherry/Dropbox (MIT)/Lab/Research Files (Dropbox)/02_Vcor paper/CK-transcriptomics_data/TRANSCRIPTOME_ANALYSIS/Ranal/virulence_genes/timelapse_log2fc_plots' 
# dir.create(save_dir)
...
#   g
   ...
   # ylim(-2.5,2.5)
    ...
    # ggsave(paste0(save_fn,'.pdf'), dpi=300, dev='pdf', height = 6, width = 5.5, units = "in",useDingbats=FALSE) # useDingbats for ggplot -> Adobe Illustrator transition (markers are not fonts)
